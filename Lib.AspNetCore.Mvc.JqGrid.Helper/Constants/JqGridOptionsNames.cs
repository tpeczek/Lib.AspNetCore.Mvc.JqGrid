namespace Lib.AspNetCore.Mvc.JqGrid.Helper.Constants
{
    internal static class JqGridOptionsNames
    {
        ...
        internal static class Navigator
        {
            ...
            internal const string AFTER_REDRAW = "afterRedraw";
            internal const string AFTER_REFRESH = "afterRefresh";
            internal const string AFTER_SHOW_FORM = "afterShowForm";
            internal const string AFTER_SHOW_SEARCH = "afterShowSearch";
            ...
            internal const string CLONE_SEARCH_ROW_ON_ADD = "cloneSearchRowOnAdd";
            ...
            internal const string CLOSE_AFTER_RESET = "closeAfterReset";
            internal const string CLOSE_AFTER_SEARCH = "closeAfterSearch";
            ...
            internal const string ON_INITIALIZE_SEARCH = "onInitializeSearch";
            internal const string ON_RESET = "onReset";
            internal const string ON_SEARCH = "onSearch";
            internal const string OVERLAY = "overlay";
            internal const string POSITION = "position";
            internal const string RECREATE_FILTER = "recreateFilter";
            ...
            internal const string SHOW_QUERY = "showQuery";
            internal const string TEMPLATES_NAMES = "tmplNames";
            internal const string TEMPLATES_FILTERS = "tmplFilters";
            internal const string TEMPLATES_FILTERS_GROUPING_OPERATOR = "groupOp";
            internal const string TEMPLATES_FILTERS_RULES = "rules";
            internal const string TEMPLATES_FILTERS_RULE_FIELD = "field";
            internal const string TEMPLATES_FILTERS_RULE_OPERATOR = "op";
            internal const string TEMPLATES_FILTERS_RULE_VALUE = "data";
