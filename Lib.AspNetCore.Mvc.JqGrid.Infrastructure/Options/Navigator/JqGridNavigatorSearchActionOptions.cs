...
namespace Lib.AspNetCore.Mvc.JqGrid.Infrastructure.Options.Navigator
{
    ...
    public class JqGridNavigatorSearchActionOptions : JqGridNavigatorActionOptions
    {
        ...
        public JqGridNavigatorSearchActionOptions()
            : base()
        {
            Width = JqGridOptionsDefaults.Navigator.SearchActionWidth;
            AfterRedraw = null;
            AfterShowSearch = null;
            BeforeShowSearch = null;
            Caption = null;
            CloseAfterSearch = JqGridOptionsDefaults.Navigator.CloseAfterSearch;
            CloseAfterReset = JqGridOptionsDefaults.Navigator.CloseAfterReset;
            ErrorCheck = JqGridOptionsDefaults.Navigator.ErrorCheck;
            SearchText = null;
            AdvancedSearching = JqGridOptionsDefaults.Navigator.AdvancedSearching;
            AdvancedSearchingWithGroups = JqGridOptionsDefaults.Navigator.AdvancedSearchingWithGroups;
            CloneSearchRowOnAdd = JqGridOptionsDefaults.Navigator.CloneSearchRowOnAdd;
            OnInitializeSearch = null;
            OnReset = null;
            OnSearch = null;
            RecreateFilter = JqGridOptionsDefaults.Navigator.RecreateFilter;
            ResetText = null;
            SearchOperators = null;
            ShowOnLoad = JqGridOptionsDefaults.Navigator.ShowOnLoad;
            ShowQuery = JqGridOptionsDefaults.Navigator.ShowQuery;
            Templates = null;
            Layer = null;
        }
        #endregion
